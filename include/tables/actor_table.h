...
/* 0x0001 */ DEFINE_ACTOR(MyCustomActor, ACTOR_MYCUSTOM, ACTOROVL_ALLOC_NORMAL, "my custom")
/* 0x0002 */ DEFINE_ACTOR(En_Test, ACTOR_EN_TEST, ACTOROVL_ALLOC_NORMAL, "En_Test")
/* 0x0003 */ DEFINE_ACTOR(En_AsylumDemon, ACTOR_EN_ASYLUMDEMON, ACTOROVL_ALLOC_NORMAL, "AsylumDemon")
/* 0x0004 */ DEFINE_ACTOR(En_GirlA, ACTOR_EN_GIRLA, ACTOROVL_ALLOC_NORMAL, "En_GirlA")
/* 0x0005 */ DEFINE_ACTOR(En_Oscar, ACTOR_EN_OSCAR, ACTOROVL_ALLOC_NORMAL, "OscarOfAstora")
/* 0x0006 */ DEFINE_ACTOR(Obj_Pillar, ACTOR_OBJ_PILLAR, ACTOROVL_ALLOC_NORMAL, "AsylumPillar")
...
/* 0x0017 */ DEFINE_ACTOR(DoorBars, ACTOR_DOORBARS, ACTOROVL_ALLOC_NORMAL, "DoorBars")
