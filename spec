...
beginseg
    name "ovl_En_AsylumDemon"
    include "build/src/overlays/actors/ovl_En_AsylumDemon/z_en_asylum.o"
    include "build/src/overlays/actors/ovl_En_AsylumDemon/ovl_En_AsylumDemon_reloc.o"
endseg
